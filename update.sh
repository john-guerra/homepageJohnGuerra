...
rsync -avzgu --delete --exclude=src --exclude=update.sh --exclude=node_modules --exclude=.git --partial -e "ssh -i /Users/aguerra/Dropbox/dutoVizNew.pem" * ubuntu@johnguerra.co:/var/www/johnguerra.co
