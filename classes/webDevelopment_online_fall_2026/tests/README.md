...
(`classes/webDevelopment_online_fall_2026/`).
...
```bash
npm run test:cs5610fall2026
```

or directly:

```bash
npx playwright test --config=classes/webDevelopment_online_fall_2026/tests/playwright.config.js
```
...
SIMULATE_BUG=1 npx playwright test \
  --config=classes/webDevelopment_online_fall_2026/tests/playwright.config.js \
