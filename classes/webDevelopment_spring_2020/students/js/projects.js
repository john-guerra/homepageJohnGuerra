...
function update(data) {
  ...
  desc
    ...
    .append("a")
    .attr("href", function(d) {
      return d["URL de su página personal"];
    })
    .text(function(d) {
  ...
  desc
    ...
    .append("a")
    .attr("href", function(d) {
      return d["URL de su página personal 2"];
    })
    .text(function(d) {
      return d["Nombres 2"] + " " + d["Apellidos 2"];
    });

  desc.append("p").text(function(d) {
    return d["Nombre del proyecto"];
  });
  ...
  body
    ...
    .append("a")
    .attr("href", function(d) {
      return d["Repositorio de github"];
    })
    .append("img")
    ...
    .attr("alt", function(d) {
      return (
        "Image " + d["Proyecto"] + " " + d["Nombres"] + " " + d["Apellidos"]
      );
    });
  ...
  desc2
    .filter(function(d) {
      return d["URL del video de demostración del proyecto en YouTube"];
    })
    .append("a")
    .attr("class", "")
    .attr("href", function(d) {
  ...
  desc2
    .filter(function(d) {
      return d["URL de la presentación en google slides"];
    })
    .append("a")
    .attr("class", "")
    .attr("href", function(d) {
...
function preProcess(data) {
  ...
  data
    .sort(function(a, b) {
      return d3.ascending(a["Marca temporal"], b["Marca temporal"]);
    })
    .forEach(function(d) {
